...
out_path <- file.path(project_path, "GSEA_result/C2CGP")  
#msigdb data input
...
ggsave(file = file.path(out_path, "barplot_toppathwaysUP.pdf"), width = 20, height = 10)
...
pdf(file = file.path(out_path, "cnetplot_upregulated.pdf"), width = 50, height = 50)
